...
class HomeController extends Controller
{
    ...
    public function indexAvaliador()
    {
        $usuario = User::findOrFail(Auth::user()->id);
        $unidade = tb_unidade::findOrFail($usuario->id_unidade_fk);
        $unidadeareas = tb_unidadesarea::where('id_unidade_fk', $unidade->id)->get();

        return view('avaliador.homeavaliador',compact('usuario','unidade','unidadeareas'));
    }
